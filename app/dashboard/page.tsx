...
export default function DashboardPage() {
  ...
  const [allocation] = useState([
    { category: "Stocks", percentage: 43.7, color: "#F7931A", value: 124500 },
    { category: "Bonds", percentage: 20.0, color: "#4C6FFF", value: 56800 },
    { category: "Real Estate", percentage: 17.0, color: "#0EF2C2", value: 48500 },
      ...
      .on(
        ...
        async (payload) => {
          ...
          if (user?.id) {
            ...
            setPortfolio(prev => ({ ...prev, pendingTransactions: pendingCount }));
          }
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-white">
              Welcome back, {user?.user_metadata?.full_name?.split(' ')[0] || user?.email?.split('@')[0] || 'Investor'}! 👋
            </h1>
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-[#0F2438] border border-gray-800 text-white rounded-lg hover:border-[#F7931A] transition-colors"
            >
        ...
        {/* Main Balance Card */}
        <div className="mb-8 p-6 md:p-8 bg-gradient-to-r from-[#F7931A]/20 via-[#4C6FFF]/10 to-[#0EF2C2]/5 rounded-2xl border border-gray-800 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#F7931A]/10 rounded-full blur-3xl -mr-20 -mt-20"></div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-gray-400 mt-2">
                  Available for trading • {formatCompactCurrency(portfolio.totalInvested)} invested
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-[#0B1C2D]/80 backdrop-blur-sm px-4 py-3 rounded-xl border border-gray-800">
                  ...
                  <p className="text-white font-bold text-lg">
                    {hideBalance ? '••••••' : formatCompactCurrency(portfolio.totalInvested)}
                  </p>
                </div>
                <div className="bg-[#0B1C2D]/80 backdrop-blur-sm px-4 py-3 rounded-xl border border-gray-800">
                  <p className="text-gray-400 text-xs">Total Returns</p>
                  <p className="text-green-500 font-bold text-lg">
                    {hideBalance ? '••••••' : formatCompactCurrency(portfolio.totalReturns)}
                  </p>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-[#0B1C2D] rounded-xl border border-gray-800 p-5 hover:border-[#F7931A]/50 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-400 text-sm">Active Investments</p>
                <p className="text-2xl font-bold text-white mt-1">{portfolio.activeInvestments}</p>
            ...
            <Link href="/dashboard/joint-investments" className="text-xs text-[#F7931A] hover:text-[#F7931A]/80 flex items-center mt-3">
          ...
          <div className="bg-[#0B1C2D] rounded-xl border border-gray-800 p-5 hover:border-[#4C6FFF]/50 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white mt-1">{portfolio.pendingTransactions}</p>
            ...
            <Link href="/dashboard/transactions" className="text-xs text-[#4C6FFF] hover:text-[#4C6FFF]/80 flex items-center mt-3">
              View transactions
              <ChevronRight className="w-3 h-3 ml-1" />
            </Link>
          </div>
          ...
          <div className="bg-[#0B1C2D] rounded-xl border border-gray-800 p-5 hover:border-[#0EF2C2]/50 transition-colors">
            ...
            <Link href="/dashboard/reports" className="text-xs text-[#0EF2C2] hover:text-[#0EF2C2]/80 flex items-center mt-3">
              View reports
              <ChevronRight className="w-3 h-3 ml-1" />
            </Link>
          </div>
          ...
          <div className="bg-[#0B1C2D] rounded-xl border border-gray-800 p-5 hover:border-[#10B981]/50 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">2 active opportunities</p>
              </div>
              <div className="p-3 bg-[#10B981]/10 rounded-lg">
                <Users className="w-6 h-6 text-[#10B981]" />
              </div>
            </div>
            <Link href="/dashboard/joint-investments" className="text-xs text-[#10B981] hover:text-[#10B981]/80 flex items-center mt-3">
              Join investments
              <ChevronRight className="w-3 h-3 ml-1" />
            </Link>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#0B1C2D] rounded-2xl border border-gray-800 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                  <button className="px-3 py-1.5 bg-[#0F2438] rounded-lg text-xs text-white border border-gray-800 hover:border-[#F7931A] transition-colors">
                    1D
                  </button>
                  <button className="px-3 py-1.5 bg-[#0F2438] rounded-lg text-xs text-white border border-gray-800 hover:border-[#F7931A] transition-colors">
                    1W
                  </button>
                  <button className="px-3 py-1.5 bg-[#F7931A] rounded-lg text-xs text-white">
                    1M
                  </button>
                  <button className="px-3 py-1.5 bg-[#0F2438] rounded-lg text-xs text-white border border-gray-800 hover:border-[#F7931A] transition-colors">
                    1Y
              ...
              <div className="h-48 flex items-end space-x-2">
                {performanceData.map((item, index) => (
                  <div key={index} className="flex-1 flex flex-col items-center">
                    <div 
                      className="w-full bg-gradient-to-t from-[#F7931A] to-[#F7931A]/60 rounded-t-lg transition-all duration-500 hover:from-[#F7931A] hover:to-[#F7931A]"
                      style={{ 
                        height: `${((item.value - 240000) / 50000) * 100}%`,
                        maxHeight: '120px',
                        minHeight: '20px'
                      }}
                    ></div>
            ...
            <div className="bg-[#0B1C2D] rounded-2xl border border-gray-800 p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Current portfolio diversification</p>
                </div>
                <Link href="/dashboard/reports" className="text-sm text-[#F7931A] hover:text-[#F7931A]/80 flex items-center">
                  View full report
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="relative w-40 h-40">
                  ...
                  <div className="absolute inset-0 rounded-full border-8 border-t-[#F7931A] border-r-[#4C6FFF] border-b-[#0EF2C2] border-l-[#8B5CF6]" style={{ 
                    clipPath: 'polygon(50% 50%, 100% 0, 100% 100%, 0 100%, 0 0)',
                    transform: 'rotate(-45deg)'
                  }}></div>
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <span className="text-2xl font-bold text-white">{formatPercent(portfolio.returnPercentage)}</span>
                    ...
                    {allocation.map((item, index) => (
                      <div key={index} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <span className="text-xs text-gray-500">{formatCompactCurrency(item.value)}</span>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0B1C2D] rounded-2xl border border-gray-800 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/transactions" className="text-sm text-[#F7931A] hover:text-[#F7931A]/80 flex items-center">
                  View all
                  <ChevronRight className="w-4 h-4 ml-1" />
                </Link>
              </div>
                    ...
                    <div key={tx.id} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className={`p-2 rounded-lg ${
                          ...
                          tx.type === 'investment' ? 'bg-[#0EF2C2]/10' :
                          'bg-blue-500/10'
                        }`}>
                          {getTypeIcon(tx.type)}
                        </div>
                        <div>
                          <p className="text-sm font-medium text-white capitalize">{tx.description}</p>
                          <div className="flex items-center space-x-2 mt-1">
                            <span className="text-xs text-gray-500">{formatDate(tx.created_at)}</span>
                            <span className="flex items-center text-xs">
                              {getStatusIcon(tx.status)}
                              <span className="ml-1 text-gray-500 capitalize">{tx.status}</span>
                            </span>
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        {tx.metadata?.btc_amount && (
                          <p className="text-xs text-[#F7931A]">{tx.metadata.btc_amount} BTC</p>
                        )}
                      </div>
                    </div>
                  ))
              ...
              <div className="mt-4 pt-4 border-t border-gray-800">
                <Link 
                  ...
                  className="w-full py-2 bg-[#0F2438] border border-gray-800 rounded-lg text-gray-400 hover:text-white hover:border-[#F7931A] transition-colors flex items-center justify-center text-sm"
                >
            ...
            <div className="bg-[#0B1C2D] rounded-2xl border border-gray-800 p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-white">Active Investments</h3>
                <Link href="/dashboard/joint-investments" className="text-sm text-[#F7931A] hover:text-[#F7931A]/80 flex items-center">
                  Manage
                  <ChevronRight className="w-4 h-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="space-y-4">
                {investments.map((investment) => (
                  <div key={investment.id} className="flex items-center justify-between group cursor-pointer hover:bg-[#0F2438] p-2 rounded-lg transition-colors">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 rounded-lg bg-[#F7931A]/20 flex items-center justify-center overflow-hidden">
                        {investment.image ? (
                          <img src={investment.image} alt={investment.name} className="w-full h-full object-cover" />
                        ) : (
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-white">{formatCompactCurrency(investment.amount)}</p>
                      <p className="text-xs text-green-500">+{formatPercent(investment.returnPercentage)}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-800">
                <Link 
                  ...
                  className="w-full py-2 bg-gradient-to-r from-[#F7931A] to-[#F7931A]/80 text-white rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center text-sm"
                >
            ...
            <div className="bg-[#0B1C2D] rounded-2xl border border-gray-800 p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link 
                  href="/dashboard/deposit"
                  className="p-3 bg-[#0F2438] border border-gray-800 rounded-xl hover:border-[#F7931A] transition-colors flex flex-col items-center"
                >
                  <div className="p-2 bg-[#F7931A]/10 rounded-lg mb-2">
                    <ArrowDownRight className="w-5 h-5 text-[#F7931A]" />
                  </div>
        ...
        {/* AI Insight Banner */}
        <div className="mt-8 p-6 bg-gradient-to-r from-[#4C6FFF]/20 via-[#F7931A]/10 to-[#0EF2C2]/5 rounded-2xl border border-gray-800 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-40 h-40 bg-[#F7931A]/10 rounded-full blur-2xl"></div>
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-start space-x-4">
              <div className="p-3 bg-[#F7931A]/20 rounded-lg">
                <Sparkles className="w-6 h-6 text-[#F7931A]" />
              </div>
              <div>
                <h4 className="text-white font-bold mb-1">AI Market Insight</h4>
                <p className="text-gray-300 text-sm max-w-2xl">
                  Based on current market trends, technology and renewable energy sectors are showing strong momentum. 
                  Consider increasing allocation to AI and clean energy funds for potential 15-20% returns this quarter.
                </p>
              </div>
            </div>
            <Link 
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-600 flex items-center justify-center">
            ...
            All transactions are encrypted and secured. Balance updated {new Date().toLocaleTimeString()}
          </p>
        </div>
      </div>
    </div>
