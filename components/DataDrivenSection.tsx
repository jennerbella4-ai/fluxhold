...
import { ArrowRightIcon, ChartBarIcon, UsersIcon, ShieldCheckIcon } from '@/components/Icons'
...
export default function DataDrivenSection() {
  ...
  return (
    <div className="pb-20 md:pb-28 bg-gradient-to-b from-[#060B14] to-[#0B1C2D]" ref={sectionRef}>
          ...
          <div className="lg:w-1/2">
            <div className="heading_block">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                We Value <span className="text-[#0EF2C2]">Data</span> for Informed Investing
              </h2>
              <p className="text-xl text-[#9BA3AF] mb-8">
                At FluxHold, we prioritize data for smarter investments. Our approach relies on thorough analysis of 
                market trends, economic indicators, and company performance—all in a risk-free demo environment.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8 mb-10">
              <div className="funfact_block">
                <div className="funfact_value flex items-end mb-3">
                  ...
                  <span className="text-3xl md:text-4xl font-bold text-[#0EF2C2] ml-1">K+</span>
                </div>
                <h4 className="funfact_title text-xl font-semibold text-[#9BA3AF]">Success Stories</h4>
                <p className="text-sm text-gray-500 mt-2">Developers who built better apps</p>
              </div>
              ...
              <div className="funfact_block">
                <div className="funfact_value flex items-end mb-3">
                  ...
                  <span className="text-3xl md:text-4xl font-bold text-[#0EF2C2] ml-1">+</span>
                </div>
                <h4 className="funfact_title text-xl font-semibold text-[#9BA3AF]">Expert Advisors</h4>
                <p className="text-sm text-gray-500 mt-2">Years of combined experience</p>
              </div>
            </div>
                  ...
                  <div className="bg-[#0B1C2D] rounded-2xl overflow-hidden border border-gray-800">
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="text-sm text-[#9BA3AF]">FluxHold Demo</div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-[#0EF2C2] text-sm font-semibold">+12.5%</div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                          <div className="bg-gray-900 rounded-lg p-3">
                            <div className="text-xs text-[#9BA3AF]">Demo Balance</div>
                            <div className="text-white font-bold">$25,000</div>
                          </div>
                          <div className="bg-gray-900 rounded-lg p-3">
                            <div className="text-xs text-[#9BA3AF]">Today's Change</div>
                            <div className="text-[#0EF2C2] font-bold">+$423.50</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="chart_image absolute -top-10 -right-10 z-20">
                <div className="bg-gradient-to-br from-[#4C6FFF] to-[#0EF2C2] p-4 rounded-2xl shadow-2xl rotate-12">
                  <div className="bg-[#0B1C2D] p-4 rounded-lg">
                    ...
                    <div className="mt-3 text-2xl font-bold text-white">24/7</div>
                    <div className="text-xs text-[#9BA3AF]">Market Simulation</div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="features_block bg-[#0B1C2D] border-2 border-gray-800 rounded-2xl p-8 hover:border-[#4C6FFF]/30 transition-all duration-300 hover:scale-[1.02] group">
              ...
              <div className="features_content">
                ...
                <p className="text-[#9BA3AF] mb-0">
                  At FluxHold we excel at demo funding & investing simulations, guiding strategic learning without real financial risk.
                </p>
              </div>
            </div>
            ...
            <div className="features_block bg-[#0B1C2D] border-2 border-gray-800 rounded-2xl p-8 hover:border-[#0EF2C2]/30 transition-all duration-300 hover:scale-[1.02] group">
              ...
              <div className="features_content">
                ...
                <p className="text-[#9BA3AF] mb-0">
                  We prioritize demo capital transparency. Our commitment ensures clarity in simulated investment scenarios.
                </p>
              </div>
            </div>
            ...
            <div className="features_block bg-[#0B1C2D] border-2 border-gray-800 rounded-2xl p-8 hover:border-[#4C6FFF]/30 transition-all duration-300 hover:scale-[1.02] group">
              ...
              <div className="features_content">
                ...
                <p className="text-[#9BA3AF] mb-0">
                  Our Secure Investment Simulation at FluxHold ensures educational stability and learning growth in a risk-free environment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 pt-12 border-t border-gray-800">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">
              Why our demo services are better than others?
            </h3>
            <p className="text-xl text-[#9BA3AF] max-w-3xl mx-auto">
              Our demo services stand out because we prioritize data quality and educational value above all else. 
              With a relentless focus on learning experience and innovative solutions.
            </p>
          </div>
          
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: 'No Real Money', desc: '100% simulated environment' },
              { title: 'Real-time Data', desc: 'Live market simulations' },
              { title: 'Educational Focus', desc: 'Learn investment concepts' },
              { title: 'Privacy First', desc: 'No financial data collected' }
            ].map((item, idx) => (
              <div key={idx} className="text-center">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#4C6FFF] to-[#0EF2C2] flex items-center justify-center mx-auto mb-4">
                  <ShieldCheckIcon className="w-6 h-6 text-white" />
                </div>
                <div className="font-bold text-white">{item.title}</div>
                <div className="text-sm text-[#9BA3AF]">{item.desc}</div>
              </div>
            ))}
          </div>
        </div>
