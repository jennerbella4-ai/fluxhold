...
export default function ExactTradingViewWidgets() {
  ...
  return (
    <div className="py-8 bg-gradient-to-b from-[#0B1C2D] to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Heading Block */}
        <div className="heading_block mb-16">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            <div className="lg:w-1/2">
              <h3 className="heading_text text-3xl lg:text-4xl font-bold mb-0">
                Why Our Services Are Better Than Others?
              </h3>
            </div>
            <div className="lg:w-1/2">
              <p className="heading_description text-lg text-[#9BA3AF] mb-0">
                Our services stand out because we prioritize data quality and
                value above all else. With relentless focus on customer
                satisfaction and innovative solutions, we provide the most
                realistic demo experience available.
              </p>
            </div>
          </div>
        </div>
